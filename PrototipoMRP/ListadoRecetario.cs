...
namespace PrototipoMRP
{
    public partial class ListadoRecetario : Form
    {
        ...
        {
            recetario = new GC_frmRecetario(generalempresa);            
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex > -1 && e.ColumnIndex > -1) {
                recetario = new GC_frmRecetario(generalempresa,dataGridView1.Rows[e.RowIndex].Cells["COD_RECETARIO"].Value.ToString());
                recetario.ShowDialog();
            }
        }
